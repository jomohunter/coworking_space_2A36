...
void MainWindow::on_loginPB_clicked()
{
        ...
        QMessageBox msgBox;
            ...
            if(username!="")
            {
            query.prepare("SELECT TYPE FROM CLIENTS WHERE username =:username AND PASSWORD =:password");
...
void MainWindow::on_COPYMESSAGE_clicked()
{ }

void MainWindow::on_COPYNUMBER_clicked()
{
}
...
void MainWindow::on_rechpb11_clicked()
{
    QMessageBox msgBox;
...
void MainWindow::on_facturePb_clicked()
{
...
void MainWindow::on_addbillpb_clicked()
{
    Client c1;
...
void MainWindow::on_pritpdfPb_clicked()
{
...
void MainWindow::on_leidrech_textChanged(const QString &arg1)
{
    QString ch = arg1;
...
void MainWindow::on_lenamerech_textChanged(const QString &arg1)
{
    QString ch = arg1;
...
void MainWindow::on_comboRech_currentIndexChanged(int index)
{
}
...
void MainWindow::on_comboBox_3_currentIndexChanged(int index) //langue principale
{
    if(index==0)
        {
            ui->label_2->setText("Name");
